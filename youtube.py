...
def Api_connect():
    Api_Id="AIzaSyDvbDsgrdyNnnmRQ9lKO4kmYNZ8DQZrLm4"
...
client=pymongo.MongoClient('mongodb+srv://Jayavarshini:Varsha333@cluster0.aslqouo.mongodb.net/?retryWrites=true&w=majority')
...
def channels_table(channel_name_S):
        ...
        for index,row in df_single_channel_detail.iterrows():
                        ...
                        try:
                                ...
                                news=f"Your Provided Channnel Name{channel_name_S}is aldready exists"
                                return news
